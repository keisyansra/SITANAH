    ...
    <div class="card-body">
      ...
      <form action="{{ url('login') }}" method="POST" id="form-login">
        ...
        <div class="input-group mb-3">
          ...
          <small id="error-username_user" class="error-text text-danger"></small>
        </div>
        <div class="input-group mb-3">
          ...
          <small id="error-password_user" class="error-text text-danger"></small>
        </div>
        <div class="row">
            <div class="col-8">
