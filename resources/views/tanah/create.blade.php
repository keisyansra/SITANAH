<form action="{{ url('/tanah/store') }}" method="POST" id="form-tambah">
    @csrf
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Tanah Makam</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="" type="text" name="kode_tanah" id="kode_tanah" class="form-control"required>
                ...
                <div class="form-group">
                    ...
                    <select name="id_lokasi" id="id_lokasi" class="form-control" required>
                        ...
                        @foreach($lokasi as $l)
                        <option value="{{ $l->id_lokasi }}" data-kota="{{ $l->kota_kab_lokasi }}">{{ $l->alamat_lokasi }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input value="" type="text" name="no_kav_tanah" id="no_kav_tanah" class="form-control"required>
                    <small id="error-no_kav_tanah" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Panjang Tanah</label>
                    <input value="" type="text" name="panjang_tanah" id="panjang_tanah" class="form-control"required>
                    <small id="error-panjang_tanah" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Lebar Tanah</label>
                    <input value="" type="text" name="lebar_tanah" id="lebar_tanah" class="form-control"required>
